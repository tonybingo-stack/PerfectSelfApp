...
typedef CIImage* (^cameraFilterType)(CIImage*);
cameraFilterType cameraFilter;
- (instancetype)init
{
    self = [super init];
    if(self){
...
//            CIImage *ciimage = [[CIImage imageWithCVPixelBuffer:pixelBuffer options:nil] imageByApplyingOrientation:kCGImagePropertyOrientationRight];
            //Omitted ciimage = cameraFilter(ciimage);
            
//            dispatch_async(dispatch_get_main_queue(), ^(void){
//                CIContext * context = [CIContext contextWithOptions:nil];
//                CGImageRef cgImage = [context createCGImage:ciimage fromRect:ciimage.extent];
//                //FIXME UIImage *previewImage = [UIImage imageWithCGImage:cgImage];
//                //FIXME [self.cameraFilterPreview setImage:previewImage];
